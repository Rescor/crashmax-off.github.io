...
// @icon        	https://crashmax-off.github.io/spaces_plus/favicon.png
...
(function() {
    function spacesPlus() {
        ...
        var _SETTINGS = {
            ...
            'isOnlineInt': 1,
            'bodystyle': {
                "url": "https://crashmax-off.github.io/spaces_plus/src/backgrounds/default.jpg",
                "color": '#DAE1E8',
                "urlchecked": true,
                "colorchecked": false
            },
            'events': {
                'url': "https://crashmax-off.github.io/spaces_plus/src/sounds/default.ogg",
                'volume': 70,
                'mail': true,
                'journal': true,
                'feed': false,
        ...
        var main = {
                                ...
                                if (data) {
                                    try {
                                        ...
                                        if (json.user_widget.id) {
                                            ...
                                            main.isFav(json.user_widget.id, favLink, nick, '<span class="ico ico_fav_on js-ico"></span><span style="color: #31bf0f;"> В закладках</span>');
                                            if (!fvtools) {
            ...
            allFixes: function() {
                var displayN = main.getClassName('span.horiz-menu__link-text');
                ...
                if (mail && lenta) {
                    mail[0].parentNode.innerHTML = '<a href="'+_PROTOCOL+'//spaces.ru/lenta" class="horiz-menu__link"><span class="horiz-menu__link-ico horiz-menu__link-ico_lenta"><span class="horiz-menu__link-event horiz-menu__link-event_show" id="lent_notif_cnt" style="display: none;"></span></span><span class="horiz-menu__link-text '+displayN+'">Лента</span></a>';
                    lenta[0].parentNode.innerHTML = '<a href="'+_PROTOCOL+'//spaces.ru/mail" class="horiz-menu__link"><span class="horiz-menu__link-ico horiz-menu__link-ico_mail"><span class="horiz-menu__link-event" id="mail_notif_cnt" style="display: none;"></span></span><span class="horiz-menu__link-text '+displayN+'">Почта</span></a>';
                }
            },
            ...
            blogTools: function() {
                var path = document.location.pathname.toString();
                if (path == '/diary/read/' != '/diary/read/user/' && !main.qs("#SP_PLUS_DELETEBL")) {
                    try {
                ...
                try {
                    if (sdm && !sdm.hasAttribute("sp-darkmode") && t) {
                        ...
                        if (_SETTINGS.darkModeNav) {
                            ...
                            sdm.innerHTML = "#left_nav{top:1px}#navi,.sidebar-logo,.unauth_header,.horiz-placeholder,.horiz-menu_bottom{color:#fff;background:#344047;border-bottom:1px solid #344047;border-left:1px solid #344047;border-right:1px solid #344047}.footer{background-color:#344047}.footer__link{border-color:#283238}.footer__link_edit .footer__link,.footer__link_tool .footer__link,.footer__link_moder .footer__link{border-color:#283238}";
            ...
            darkModeNav: function(t) {
                try {
                    ...
                    var dmCheck = main.ce("label", {
                        ...
                        html: "- изменить цвет шапки и футера",
                        style: "font-size: small;"
                    });
