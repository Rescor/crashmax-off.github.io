                                    ...
                                    if (setArea) {
                                        for (var i in _SETTINGS) {
                                            if (i == 'bodystyle') {
                                                ...
                                                console.log(_SETTINGS.bodystyle.color);
