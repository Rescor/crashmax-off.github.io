            ...
            darkModeNav: function(e) {
                try {
                    ...
                    var dm = main.ce("input", {
                        ...
                        onclick: function(e) {
                            _SETTINGS.darkModeNav = e.target.checked;
                            var jsonSet = JSON.stringify(_SETTINGS);
                            main.setCookie("SP_PLUS_SET", jsonSet, null);

                            if (sdm && !sdm.hasAttribute("sp-darkmode-nav") && e) {
                                ...
                                parent.appendChild(sdm);
                            } else if (!_SETTINGS.darkModeNav && sdm && sdm.hasAttribute("sp-darkmode-nav") && !e) {
                    ...
                    main.insertAfter(dmNav, e.nextElementSibling.nextElementSibling);
                } catch (e) {
                    main.console.error('Ошибка (DARKMODE-NAV): ' + e.name + ":" + e.message + "\n" + e.stack);
                }
            },
            setStyle: function() {
