        ...
        var main = {
            ...
            spacesAction: function(root) {
                ...
                var apidebug = main.ce("a", {
                    ...
                    html: "<span class='b'>API-Debugger<span> - Тестировние API сайта.</span></span>",
                    style: "font-size: small;",
                    onclick: function(e) {
                ...
                var sndbeta = main.ce("a", {
                    ...
                    html: (beta ? "<span class='b'>Выйти из песочницы</span>" : "<span class='b'>Beta-песочница<span> - Открытое тестирование нововведений сайта.</span></span>"),
                    style: "font-size: small;",
                    onclick: function(e) {
                        if (beta) {
                            main.delCookie("beta");
                ...
                var fatWrap = main.ce("a", {
                    ...
                    class: "stnd-link",
                    id: "sp_spacesFAT",
                    html: (fat ? "<span class='b'>Убрать полосу загрузки</span>" : "<span class='b'>Добавить AJAX полосу загрузки страницы.<span>"),
                    style: "font-size: small;",
                    onclick: function(e) {
                        if (fat) {
                ...
                var glbWrap = main.ce("a", {
                    ...
                    class: "stnd-link",
                    id: "sp_spacesGLB",
                    html: (glb ? "<span class='b'>Убрать плеер из панели</span>" : "<span class='b'>Переместить плеер - переносит кнопку открытия плеера в левую панель.</span>"),
                    style: "font-size: small;",
                    onclick: function(e) {
                        if (glb) {
                ...
                var nbqLink = main.ce("a", {
                    ...
                    class: "stnd-link",
                    html: "<span class='b'>Скрыть квест новичка</span>",
                    onclick: function(e) {
                        var CK = main.getCK(0);
                    ...
                    var dm = main.ce("input", {
                        ...
                        onclick: function(t) {
                            ...
                            if (sdm && !sdm.hasAttribute("sp-darkmode-nav") && t) {
                                ...
                                parent.appendChild(sdm);
                            } else if (!_SETTINGS.darkModeNav && sdm && sdm.hasAttribute("sp-darkmode-nav") && !t) {
